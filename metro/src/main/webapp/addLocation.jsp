                    ...
                    <div class="card-body" style="background-color: white;">
                        <form action="location/${dto.email}" id="myForm" method="post">
                            <div class="col-md-6 mb-1">
                                <div class="mb-3">
                                    <div>
                                        <h5 class="text-right" style="color:black;">ADD LOCATIONS</h5>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <label for="trainNumber" class="form-label" style="color:black;">Train
                                        Number</label>
                                ...
                                <div class="mb-3">
                                    <label for="addTrainType" class="form-label" style="color:black;">Add Train
                                        Type</label>
                                ...
                                <div class="mb-3">
                                    <label for="locationsName" style="color:black;" class="form-label">Select
                                        Station</label>
