            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img
                    src="https://upload.wikimedia.org/wikipedia/commons/5/54/Namma_Metro%27s_Purple_Line_trainset.jpg"
                ...
                <div class="carousel-item">
                  <img
                    src="https://www.newprojectstracker.com/blog/wp-content/uploads/2022/06/RITES-files-DPR-for-two-corridors-of-BMRCL.jpg"
                    class="d-block w-100" alt="..." style="height: 100%;">
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-4 d-flex align-items-stretch">
              <div class="card">
                ...
                <div class="card-body">
                  <p class="card-text text-center">The metro is an efficient, fast, and eco-friendly way to travel
                    within the city.</p>
                </div>
              </div>
            </div>
            <div class="col-md-4 d-flex align-items-stretch">
              <div class="card">
                <img src="https://maps-washington-dc.com/img/1200/dc-metro-rail-map.jpg" class="card-img-top"
                  alt="Image 2">
                <div class="card-body">
                  <p class="card-text text-center">Trains operate on time, ensuring that commuters can rely on the metro
                    for timely travel.</p>
                </div>
              </div>
            </div>
            <div class="col-md-4 d-flex align-items-stretch">
              <div class="card">
                <img src="https://www.metrorailnews.in/wp-content/uploads/2020/06/697094-jaipur-metro-02-1.jpg"
                  class="card-img-top" alt="Image 3">
                <div class="card-body">
                  <p class="card-text text-center">The metro system is continuously expanding to serve more areas,
                    making it easier for everyone.</p>
                </div>
              </div>
            </div>
          </div>
