                    ...
                    <div class="p-3 bg-secondary-subtle text-secondary-emphasis">
                        ...
                        <form action="updateUserDetails" method="post" enctype="multipart/form-data">
                            <div class="text-center">
                                <img src="readImage/${dto.imageName}"
                                    style="height: 150px; width: 150px; border-radius: 50px;">
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="fName"
                                            placeholder="Enter your first name" onchange="fNameValidation()"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="lName"
                                            placeholder="Enter your last name" onchange="lNameValidation()"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="phNo"
                                            placeholder="Enter your contact number" name="phNo" onblur="phone()"
                                            value="${dto.mobileNumber}" required>
                                        <span id="ph"></span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <input type="password" class="form-control" id="password" required
                                            placeholder="Enter your password" name="password" onchange="passwordEntry()"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <input type="password" class="form-control" id="confirmPassword" required
                                            placeholder="Confirm your password" onblur="confirm()"
                                            name="confirmPassword" value="${dto.password}" hidden>
