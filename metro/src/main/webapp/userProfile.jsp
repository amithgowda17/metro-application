<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
 ...
 <input type="number" class="form-control" id="id" placeholder="Enter your first name"
                       name="id" value="${dto.id}" hidden>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="phNo" placeholder="Enter your contact number"
                      name="mobileNumber" onblur="phone()" value="${dto.mobileNumber}" required>
                    <span id="ph"></span>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="password" class="form-control" id="confirmPassword" required
                    placeholder="Confirm your password" onblur="confirm()" name="confirmPassword" value="${dto.password}" hidden>
      ...
      <script>
          ...
          function fNameValidation() {
                ...
                const phone = async () => {
                  ...
                  var button = document.getElementById("button");
                  const response = await axios("http://localhost:8080/metro/phoneNumberExists?phNo=" + phoneNumber)
