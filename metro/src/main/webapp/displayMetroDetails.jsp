    ...
    <%@ page isELIgnored="false" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <body class="d-flex flex-column" style="min-height: 100vh;">
                <header class="bg-dark text-white text-center py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <nav class="d-flex justify-content-center">
                            ...
                            <a href="addTimings?email=${dto.email}"
                            ...
                            <a href="addTrainType?email=${dto.email}" class="btn btn-outline-light btn-sm mx-2">Add
                                Train</a>
                            <a href="addPriceList?email=${dto.email}"
                                class="btn btn-outline-light btn-sm mx-2">Price</a>
                            <a href="readTrain?email=${dto.email}" class="btn btn-outline-light btn-sm mx-2">View
                                Data</a>
                        </nav>
                ...
                <table class="table table-hover mx-auto rounded-3 border" style="width: 60%;">
