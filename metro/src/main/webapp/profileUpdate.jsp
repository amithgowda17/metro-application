                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="fName" placeholder="Enter your first name"
                     name="fname" required value="${dto.fname}" onblur="fNameValidation()">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="lName" placeholder="Enter your last name"
                     name="lname" required value="${dto.lname}" onblur="lNameValidation()">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="city" required placeholder="Enter your city"
                       name="city"  value="${dto.city}" onblur="cityName() ">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="pinCode" required placeholder="Enter your pincode"
                      name="pinCode"   value="${dto.pinCode}" onblur="pinCodeValid()">
                    <span id="pin"></span>
                  </div>
                </div>
