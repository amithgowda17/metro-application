    ...
    <header class="bg-dark text-white text-center py-3">
        ...
        <img src="https://www.x-workz.in/Logo.png" alt="Logo" style="max-height: 50px;">
            ...
            <nav class="d-flex justify-content-center">
                ...
                <a href="addTrainType?email=${details.email}" class="btn btn-outline-light btn-sm mx-2">Add Train</a>
                <a href="addPriceList?email=${details.email}" class="btn btn-outline-light btn-sm mx-2">Price</a>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">The metro trains are modern, comfortable, and efficient, designed to provide a seamless travel experience for commuters. It runs on all major routes of the city, covering significant locations.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Check the metro route map to find the best route for your commute. The metro system covers the entire city and connects major landmarks and residential areas.</p>
                    </div>
                </div>
            </div>
        </div>
