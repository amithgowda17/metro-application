          ...
          <div class="row align-items-center">
            ...
            <div class="col-auto d-flex ">
              <button type="button" class="btn btn-primary me-2">
                <a href="registerPage" style="text-decoration: none; color: white;">Admin Register</a>
              </button>
              <button type="button" class="btn btn-primary">
                <a href="loginPage" style="text-decoration: none; color: white;">Admin Login</a>
              </button>

              <button type="button" class="btn btn-primary me-2">
                <a href="userRegister" style="text-decoration: none; color: white;">User Register</a>
              </button>
              <button type="button" class="btn btn-primary">
                <a href="userCanLoginHere" style="text-decoration: none; color: white;">User Login</a>
              </button>
            </div>
          </div>
        </div>
