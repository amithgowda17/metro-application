  ...
  <%@ page isELIgnored="false" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
      ...
      <head>
        ...
        <title>Updata Metro Details</title>
          ...
          <div class="card-body" style="background-color: black;">
            <form action="updateDetails" method="Post">
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="addTrainId" name="addTrainId"
                  value="${addTrainDto.addTrainId}" hidden>
              </div>
              <input type="email" id="email" name="email" placeholder="user@gmail.com" id="emailId" value="${dto.email}"
                hidden>
              <div class="mb-3">
